...
export function Projects() {
	return (
		<section className="flex flex-col px-8 mt-24 mb-12" id="projects">
			<h1 className="font-bold font-nunito text-2xl text-DarkRed dark:text-red">Meus Projetos</h1>

			<div className="grid md:grid-cols-3 sm:grid-cols-2 gap-4 mt-12">

				{projectsArray.map(project => (
					<a data-aos="fade-up" target="_blank" href={project.link} key={project.name} className="flex flex-col mb-4 group" rel="noreferrer">
